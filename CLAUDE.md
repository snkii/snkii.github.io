...
- 4K 등 큰 화면의 gradient banding을 줄이기 위해 canvas 이미지에 pixel-level RGB dither를 적용하고 아주 약한 soft-light noise overlay를 함께 사용. Windows Chrome에서는 dither/noise를 더 강하게 적용
